...
from bar_tokyonight import bar
...
layout_theme = {
    "border_width": 3,
    "margin": 5,
    "border_focus": TokyoNight["color8"],
    "border_normal": TokyoNight["color0"],
}

layout_floating_theme = {
    "border_width": 5,
...
directory_path = "/home/bugs/myAestheticWalls/"
random_image_path = get_random_image_filepath(directory_path)

screens = [Screen(top=bar, wallpaper=random_image_path, wallpaper_mode="fill")]
